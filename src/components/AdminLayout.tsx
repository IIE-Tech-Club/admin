      ...
      <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4 font-orbitron">
        <div className="glass-card max-w-md w-full p-12 text-center border-red-500/20">
          ...
          <p className="text-slate-400 text-sm mb-10 leading-relaxed uppercase tracking-widest font-bold">
            Identity verification required to access this node. Execute
          ...
          <div className="h-20 w-20 bg-red-500/10 border border-red-500/30 rounded-full flex items-center justify-center mx-auto mb-8">
            ...
            >
              <path
                ...
                strokeLinejoin="round"
                strokeWidth={2}
                d="M12 11c0 3.517-1.009 6.799-2.753 9.571m-3.44-2.04l.054-.09A10.003 10.003 0 0112 3c1.737 0 3.37.439 4.8 1.214m.2 13.607a10.003 10.003 0 01-4.8 1.214h-.008"
              />
            </svg>
          </div>
          <h2 className="text-2xl font-black mb-4 tracking-tighter uppercase">
            ...
            <div className="flex flex-wrap items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-4">
                <div className="h-2 w-32 bg-slate-800 rounded-full overflow-hidden border border-cyan-500/10 hidden sm:block">
                  <div
                    className="h-full bg-cyan-400 status-glow"
                    style={{ width: "65%" }}
                  />
                </div>
                <button type="button" className="neon-btn-cyan !py-2 !px-4">
